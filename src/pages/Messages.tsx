...
const Messages: React.FC = () => {
  ...
  const quickReplies = [
    'Осталось 3 авто в наличии в этом цвете. Хотите забронировать на 24 часа?',
    'Завтра ожидаем поставку этого цвета. Могу поставить в лист ожидания.',
    'Могу снять видео-осмотр: ЛКП/салон/запуск/свет. Что именно показать?',
    'Для расчёта финальной цены напишите: комплектацию, цвет и какие опции интересуют.',
    'Можем записать на тест-драйв на завтра: шоссе/город/бездорожье — какой маршрут удобнее?',
  ];
  ...
  const sendAttachmentLink = () => {
    const url = attachUrl.trim();
    if (!url) return;
    insertTemplate(`📎 Ссылка/вложение: ${url}`);
  };
            ...
            <Col lg={8}>
              <Card className="shadow-sm">
                <Card.Header className="d-flex justify-content-between align-items-center">
                  <span>Диалог с салоном</span>
                  <Button variant="outline-secondary" size="sm" onClick={() => loadClientThread()}>
                    Обновить
                  </Button>
                </Card.Header>
                <Card.Body>
                  {loading && !thread ? (
                    ...
                    <>
                      <div className="chat-thread mb-3">
                        {thread?.messages.length === 0 && (
                          <p className="text-muted small mb-0">
                            Пока нет сообщений. Напишите вопрос — менеджер ответит в этом окне.
                          </p>
                        )}
                      ...
                      <Form onSubmit={handleSend}>
                        <div className="d-flex flex-wrap gap-2 mb-2">
                          <Button
                            ...
                            onClick={() => insertTemplate('Хочу узнать финальную цену с учётом скидок и доп. оборудования.')}
                          >
                            Запросить расчёт
                          </Button>
                          <Button
                            ...
                            size="sm"
                            variant="outline-secondary"
                            onClick={() => insertTemplate('Хочу видео-осмотр конкретного авто (ЛКП/салон/двигатель).')}
                          >
                            Видео-осмотр
                          </Button>
                          <Button
                            ...
                            size="sm"
                            variant="outline-secondary"
                            onClick={() => insertTemplate('Хочу записаться на тест-драйв. Маршрут: город/шоссе/бездорожье.')}
                          >
                            Тест-драйв
                          </Button>
                        </div>
                        <div className="d-flex gap-2 mb-2">
                          <Form.Control
                            ...
                            placeholder="Вставьте ссылку на чек/фото/документ (MVP)"
                          />
                          <Button
                            type="button"
                            size="sm"
                  ...
                  {!thread ? (
                    ...
                    <>
                      ...
                      <Form onSubmit={handleSend}>
                        {staffSection === 'clients' && (
                          <div className="mb-2">
                            <div className="text-muted small mb-1">Быстрые ответы</div>
                        ...
                        <div className="d-flex gap-2 mb-2">
                          <Form.Control
                            ...
                            value={attachUrl}
                            onChange={(e) => setAttachUrl(e.target.value)}
                            placeholder="Ссылка на чек/фото/документ (MVP)"
                          />
                          <Button
                            type="button"
                            size="sm"
